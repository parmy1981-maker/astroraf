const translations = {
  nl: {
    ...
    shop_note: `De shop is nog in opbouw. Heb je nu al interesse in een poster of T-shirt? Stuur gerust een bericht via de social media-links hieronder, dan hou ik je op de hoogte zodra alles klaarstaat.`,
    ...
    cart_checkout_note: `Afrekenen via de site volgt nog. Stuur ondertussen een bericht via de social media-links om je bestelling door te geven.`,
  ...
  en: {
    ...
    shop_note: `The shop is still under construction. Already interested in a poster or T-shirt? Feel free to message me through the social links below and I'll keep you posted once everything is ready.`,
    ...
    cart_checkout_note: `Checkout through the site is still coming. In the meantime, send a message through the social links to place your order.`,
  ...
  fr: {
    ...
    shop_note: `La boutique est encore en construction. Déjà intéressé par un poster ou un T-shirt ? N'hésite pas à m'envoyer un message via les réseaux sociaux ci-dessous, je te tiendrai informé dès que tout sera prêt.`,
    ...
    cart_checkout: `Payer`,
    cart_checkout_note: `Payer via le site arrive bientôt. Envoie-moi entre-temps un message via les réseaux sociaux pour passer ta commande.`,
  ...
  de: {
    ...
    shop_note: `Der Shop befindet sich noch im Aufbau. Schon jetzt Interesse an einem Poster oder T-Shirt? Schreib mir gerne über die Social-Media-Links unten, ich halte dich auf dem Laufenden, sobald alles bereit ist.`,
    ...
    cart_checkout_note: `Bezahlen über die Website folgt noch. Schreib mir in der Zwischenzeit über die Social-Media-Links, um deine Bestellung durchzugeben.`,
